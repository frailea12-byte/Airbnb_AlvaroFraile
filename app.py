...
with tab1:
    ...
    with col_t2:
        ...
        tabla2 = (df_filtrado.groupby("neighbourhood")["reviews_per_month"].mean().reset_index().rename(columns={"neighbourhood": "Barrio", "reviews_per_month": "Media reseña/mes"}).sort_values("Media reseñas/mes", ascending=False).head(10))
